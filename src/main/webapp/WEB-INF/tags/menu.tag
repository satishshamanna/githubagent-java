 ...
 * User Name: Satish
 * Brief Description of Change: Added Billing menu item to navigation header.
--%>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="main-navbar" style>
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <petclinic:menuItem active="${name eq 'invoices'}" url="/admin/invoices"
                                    title="billing" glyph="fa-credit-card">
                    <span>Billing</span>
                </petclinic:menuItem>
