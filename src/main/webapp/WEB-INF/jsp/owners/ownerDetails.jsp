...
<%--
  ...
  User Name: Satish
  Brief Description of Change: Added Book Appointment link and change metadata to ownerDetails JSP.
--%>
                                    ...
                                    <td>
                                        <table class="table-condensed" aria-describedby="petsAndVisits">
                                            ...
                                            <c:forEach var="visit" items="${pet.visits}">
                                                <tr>
                                                    <td headers="visitDate">
                                                        <petclinic:localDate date="${visit.date}"
                                                            pattern="yyyy-MM-dd" />
                                                    </td>
                                                    <td headers="visitDescription">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     ...
                                                     &nbsp;&nbsp;&nbsp;&nbsp;
                                                     <spring:url value="/owners/{ownerId}/pets/{petId}/appointments/new"
                                                         var="apptUrl">
                                                         <spring:param name="ownerId" value="${owner.id}" />
                                                         <spring:param name="petId" value="${pet.id}" />
                                                     </spring:url>
                                                     <a href="${fn:escapeXml(apptUrl)}">Book Appointment</a>
                                                 </td>
                                            </tr>
                                        </table>
                                    </td>
